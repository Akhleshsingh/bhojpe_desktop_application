          ...
          <Box sx={{
            ...
            <Box sx={{
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 1.2 }}>
                ...
                <Box>
                  <Typography sx={{ fontSize: 15, fontWeight: 700, color: "#FFFFFF", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    Apply Discount
                  </Typography>
            ...
            <Box sx={{ p: 2.5, display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                {[{ v: "fixed", l: "Fixed (₹)" }, { v: "percent", l: "Percentage (%)" }].map(({ v, l }) => (
                  <Box key={v} onClick={() => { setDiscountType(v as any); setDiscountValue(0); }}
                    sx={{
                      ...
                      cursor: "pointer", fontSize: 13, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif",
              ...
              <Box>
                <Typography sx={{ fontSize: 11, fontWeight: 600, color: "#9CA3AF", fontFamily: "'Plus Jakarta Sans', sans-serif", mb: 0.8, textTransform: "uppercase", letterSpacing: 0.5 }}>
                ...
                <Box sx={{ display: "flex", gap: 1 }}>
                  {(discountType === "percent" ? [5, 10, 15, 20] : [50, 100, 150, 200]).map(v => (
                    <Box key={v} onClick={() => setDiscountValue(v)}
                      ...
                      <Typography sx={{ fontSize: 12, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif", color: discountValue === v ? "#FF3D01" : "#374151" }}>
              ...
              <Box>
                ...
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <Box sx={{ mr: 0.5, color: "#9CA3AF", fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 18, fontWeight: 700 }}>
                        {discountType === "fixed" ? "₹" : "%"}
                      </Box>
                    ),
                  }}
                  sx={{
                    "& .MuiOutlinedInput-root": {
                      height: 52, fontSize: 22, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif",
                ...
                {discountValue > 0 && (
                  <Box sx={{ mt: 1, display: "flex", justifyContent: "space-between", px: 1 }}>
                    ...
                    <Typography sx={{ fontSize: 13, fontWeight: 700, color: "#16A34A", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                      -{discountType === "fixed"
                        ? `₹${discountValue}`
              ...
              <Box sx={{ display: "flex", gap: 1.2, pt: 0.5, borderTop: "1px solid #F3F4F6" }}>
                ...
                <Button fullWidth variant="contained"
                  ...
                  sx={{
                    textTransform: "none", fontSize: 13, fontWeight: 700, fontFamily: "'Plus Jakarta Sans', sans-serif",
                    height: 42, borderRadius: "10px",
